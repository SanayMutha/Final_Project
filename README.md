# Final_Project
Wordpress Final project for AWS Class in Dankook University
...
```bash
mysql -h finalproject-wordpress.chgsqsaiq7bn.us-east-1.rds.amazonaws.com -P 3306 -u admin -p
```
...
CREATE USER 'wpuser' IDENTIFIED BY 'Dankook2026';
...
define( 'DB_PASSWORD', 'Dankook2026' );
